...
</style></head><body><div class="wrap">${slideInner(s)}</div><div class="brand">@dongsp_official</div></body></html>`;
}
...
</style></head><body><div class="wrap"><div class="panel">${slideInner(s)}</div></div><div class="brand">@dongsp_official</div></body></html>`;
}
